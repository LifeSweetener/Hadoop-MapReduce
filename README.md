...
<p align="justify">А запускается требуемый в <a href="#task">задании</a> к этой работе клиент, рекомендующий товары покупателям, через <b>bash-скрипт</b>, который лежит в папке <i>"target"</i> и называется <b>"client.sh"</b>.</p>
