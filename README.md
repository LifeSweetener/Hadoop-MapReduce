...
<p align="center"><img src="docs/1.jpg" width="80%" height="90%" title="Слайд из презентации преподавателя на одной из лекций" alt="Слайд из презентации преподавателя на одной из лекций: программист сам реализует map и reduce, когда пишет MapReduce"></img></p>
